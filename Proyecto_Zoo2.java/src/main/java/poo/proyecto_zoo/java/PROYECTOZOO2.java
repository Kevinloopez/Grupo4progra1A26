...
public class PROYECTOZOO2 {
    ...
    try {
        ...
        while (rs.next()) {
            encontrado = true; //si el valor de "encontrado" es verdadero, se ejecuta la instrucción del if (busqueda)
    ...
    public static void estadisticas() {
        ...
        try {
            ...
            ResultSet rsTotal = psTotal.executeQuery(); //almacenamos el dato obtenido en una variable
